    ...
    Class.prototype.renderData = function(res, curr, count, sort){
        var that = this
            ...
            ,render = function(){ //后续性能提升的重点
                ...
                layui.each(data, function(i1, item1){
                    ...
                    that.eachCols(function(i3, item3){
                        ...
                        var td = ['<td data-field="'+ field +'" '+ function(){
                          ...
                          //  if(item3.rhtml) attr.push('data-minwidth="'+ item3.minWidth +'"'); //自定义html
                            return attr.join(' ');
                        }() +'>'
                ...
                if(that.config.$scope)//增加对angular的支持，主要是编译动态生成的东西，比如在toolbar或者Templete中生成的angular元素，进行编译。
                that.config.$compile(that.elem)( that.config.$scope)
            };
