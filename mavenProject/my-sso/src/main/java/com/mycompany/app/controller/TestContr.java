...
public class TestContr implements EnvironmentAware {
	...
	@ResponseBody
	 @ApiOperation(value = "��ȡ�û��б�1", notes = "2")  
	 @ApiImplicitParam(name = "userid", value = "�û�ID", required = true, dataType = "String")  
	//@ApiOperation(value="����ID��ȡ�û���Ϣ",httpMethod="POST",notes="get user by id",response=ApiResult.class) 
